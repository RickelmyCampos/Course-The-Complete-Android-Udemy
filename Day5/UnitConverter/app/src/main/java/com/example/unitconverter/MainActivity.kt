...
fun UnitConverter() {
    ...
    fun convertUnits() {
        ...
        val result =
            (inputValueDouble * conversionFactor.value * 100 / oConversionFactor.value).roundToInt() / 100.00
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            //placeholder = { Text(text = "Digite seu texto") },
            label = { Text(text = "Digite seu texto") })
        Spacer(modifier = Modifier.height(16.dp))
        Row {
            Box {
                ...
                DropdownMenu(expanded = iExpanded, onDismissRequest = { iExpanded = false }) {
                    ...
                    DropdownMenuItem(
                        ...
                        onClick = {
                            iExpanded = false
                            inputUnit = "Milimetros"
                            conversionFactor.value = 0.3048
                            convertUnits()
                        }
                    )
                    DropdownMenuItem(
                        text = { Text(text = "Milimetros") },
                        onClick = {
                            iExpanded = false
                            inputUnit = "Milimetros"
        ...
        Spacer(modifier = Modifier.height(16.dp))
        Text(text = "Resultado : $outputValue $outputUnit", style = MaterialTheme.typography.headlineMedium)
    }
}
